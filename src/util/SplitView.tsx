// by https://blog.theodo.com/2020/11/react-resizeable-split-panels/
...
interface SplitViewProps {
  ...
  className?: string;
  onResized?: (firstWidth: number, secondWidth: number) => void;
}
    ...
    if (dragging && leftWidth && separatorXPosition) {
      ...
      if (splitPaneRef.current) {
        ...
        if (newLeftWidth > splitPaneWidth - MIN_WIDTH) {
          ...
          if (onResized) {
            onResized(newLeftWidth, splitPaneWidth - newLeftWidth);
          }
          return;
        }
      }
